...
import { Button, Checkbox, Input, MoneyInput, Select } from "../../../components/ui";
import * as Yup from 'yup'
import { FormNumericInput, Loading } from "../../../components/shared";
import { useState } from "react";


const ServiceUpsert = ({ data, onClose }) => {
                            ...
                            <div className="flex gap-4 w-full mt-4">
                                <div className='mt-2 w-6/10'>
                                    ...
                                    >
                                        <Field name="email">
                                            {({ field, form }) => (
                                                <Input textArea placeholder="Descrição do Serviço" />
                                            )}
                                        </Field>
                                    </FormItem>
                                ...
                                <div className="h-auto border-1 border-dashed border-gray-500" />
